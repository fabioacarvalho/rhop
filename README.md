...
| `RH\_ADMIN` | Todas | Aprovar/rejeitar, configurar fluxos, ver auditoria |
...
DATABASE\_URL=              # connection string do Supabase (Postgres)
...
CRON\_SECRET=                # token simples para proteger o endpoint de SLA
